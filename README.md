...
- [Ren'Py：从入门到入坟](#renpy从入门到入坟)
  ...
  - [Ren'Py语法](#renpy语法)
    ...
    - [脚本标签（label）](#脚本标签label)
      ...
      - [特殊标签名](#特殊标签名)
      - [全局（global）与本地（local）脚本标签（不常用）](#全局global与本地local脚本标签不常用)
    - [对话呈现](#对话呈现)
      - [say语句](#say语句)
      - [特殊文本样式](#特殊文本样式)
        - [转义符](#转义符)
...
label .local_label:
  ...
  "这是本地脚本标签.local_label，关联start全局脚本标签"
...
在上面的代码中，有 *start* 和 *globel_label* 全局脚本标签，其分别关联了 *.local_label* 本地脚本标签。
